...
books.forEach((val)=>{
    ...
    <div class="col-3 m-1 col-sm-12 ms-2 me-2 w3-hover-border-amber w3-hover-black card " id="" style="width:10%;">
    ...
    `
    noBels.innerHTML+= `
    <div class="col-3 m-1 col-sm-12 ms-2 me-2 w3-hover-border-amber w3-hover-black card " id="" style="width:20%;">
    <div class="card-body book">
    <div class="card-text"><h3 class="info ">${val.volumeInfo.title}</h3></div>
        <div class="card-img-top"><img src="${val.volumeInfo.imageLinks.thumbnail}" class="img-fluid" style="width:100%;" alt=""></div>
    </div>
